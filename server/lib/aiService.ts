...
7. BE FLEXIBLE - If files are missing, create minimal placeholders or use generic approaches
8. PRIORITIZE WORKING DOCKER IMAGE over perfect optimization
  ...
  try {
    ...
    if (process.env.AUTO_BUILD === 'true') {
      try {
        ...
        // Ensure image name is always lowercase (fallback safety)
